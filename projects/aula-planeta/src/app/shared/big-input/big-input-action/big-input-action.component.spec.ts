...
@Component({
  selector: 'aula-planeta-host-for-test',
  template: ''
})
class HostComponent {
  actionHandler = () => {};
...
describe('BigInputActionComponent', () => {
  ...
  it('should be created', () => {
    const template = '<aula-planeta-big-input-action></aula-planeta-big-input-action>';
  ...
  it('should disable button if disabled property is set', () => {
    const template =
      '<aula-planeta-big-input-action [disabled]="true"></aula-planeta-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should display icon if fontSet and fontIcon properties are set', () => {
    const template =
      '<aula-planeta-big-input-action fontSet="fas" fontIcon="fa-trash"></aula-planeta-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should display label with provided text when label property is set', () => {
    const template =
      '<aula-planeta-big-input-action label="delete"></aula-planeta-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should emit action event on button click', () => {
    const template =
      '<aula-planeta-big-input-action (action)="actionHandler()"></aula-planeta-big-input-action>';
    fixture = createHostComponent(template);
