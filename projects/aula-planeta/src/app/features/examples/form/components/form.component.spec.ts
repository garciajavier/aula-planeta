...
describe('FormComponent', () => {
  ...
  const getSaveButton = () =>
    loader.getHarness(
      MatButtonHarness.with({ text: 'aula-planeta.examples.form.save' })
    );

  const getResetButton = async () =>
    loader.getHarness(
      MatButtonHarness.with({ text: 'aula-planeta.examples.form.reset' })
    );
  ...
  it('should save form', async () => {
    ...
    await usernameInput.setValue('javgarjim');
